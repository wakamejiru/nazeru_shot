...
export const ImageAssetPaths = Object.freeze({
  AvatarType1:  "../image/avatar/Player1.png",
...
export const  enemy_info_list = {
    ...
    [EnemyTypeEnum.E_TYPE_1]:
    {
        ...
        e_limit_break_point: 0.6,
        move_wait_duration: 3.0,
        next_move_interval: 3.0,
        shooting_phases_number: 5.0,
        enemy_hp_guage: 5,
        enemy_play_ult: 0.5,
        attack_variation: 5,
        attack_watingtime:2.0,
    },
    [EnemyTypeEnum.E_TYPE_3]:
    {
        enemy_name:"ENEMY3",
        enemy_image_key:"EnemyTypeA",
        enemy_hitpoint_radius:100,
        ...
        enemy_mag:0,
        e_ult_type: EnemyUltTypeEnum.E_ULT_1,
        e_limit_break_point: 0.55,
        move_wait_duration: 2.5,
        next_move_interval: 3.0,
        shooting_phases_number: 3.0,
        enemy_hp_guage: 3,
        enemy_play_ult: 0.5,
        attack_variation: 3,
        attack_watingtime:2.0,
    },
    [EnemyTypeEnum.E_TYPE_4]:
    {
        enemy_name:"ENEMY4",
        enemy_image_key:"EnemyTypeA",
        enemy_hitpoint_radius:100,
    ...
    [EnemyTypeEnum.E_TYPE_5]:
    {
        ...
        enemy_play_ult: 0.5,
        attack_variation: 3,
        attack_watingtime:2.5,
    },
    [EnemyTypeEnum.E_TYPE_6]:
    {
        enemy_name:"ENEMY6",
        enemy_image_key:"EnemyTypeA",
        enemy_hitpoint_radius:100,
    ...
    [EnemyTypeEnum.E_TYPE_7]:
    {
        ...
        e_ult_type: EnemyUltTypeEnum.E_ULT_1,
        e_limit_break_point: 0.5,
        move_wait_duration: 1.5,
        next_move_interval: 2.5,
        shooting_phases_number: 3.0,
        enemy_hp_guage: 3,
        enemy_play_ult: 0.5,
        attack_variation: 3,
        attack_watingtime:1.5,
    },
    [EnemyTypeEnum.E_TYPE_8]:
    {
        enemy_name:"ENEMY8",
        enemy_image_key:"EnemyTypeA",
        enemy_hitpoint_radius:100,
    ...
    [EnemyTypeEnum.E_TYPE_10]:
    {
        ...
        enemy_mag:0,
        e_ult_type: EnemyUltTypeEnum.E_ULT_1,
        e_limit_break_point: 0.4,
        move_wait_duration: 1.0,
        next_move_interval: 2.0,
        shooting_phases_number: 4.0,
        enemy_hp_guage: 4,
        enemy_play_ult: 0.5,
        attack_variation: 4,
        attack_watingtime:1.0,
    },
    [EnemyTypeEnum.E_TYPE_11]:
    {
        enemy_name:"EXTRA1",
        enemy_image_key:"EnemyTypeA",
        enemy_hitpoint_radius:100,
        ...
        enemy_mag:0,
        e_ult_type: EnemyUltTypeEnum.E_ULT_1,
        e_limit_break_point: 0.35,
        move_wait_duration: 1.0,
        next_move_interval: 1.5,
        shooting_phases_number: 5.0,
        enemy_hp_guage: 5,
        enemy_play_ult: 0.4,
        attack_variation: 5,
        attack_watingtime:0.8,
    },
}
